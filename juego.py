...
def main():
    ...
    #NAVE ESPACIAL
    ship_id = c.create_rectangle(0,0,30,30,fill='yellow',tag='nave')
    ship_id2 = c.create_oval(0,0,30,30,outline='blue',tag='nave')
    SHIP_RADIUS = 15
    MID_X = WIDTH / 2
    MID_Y = HEIGHT / 2
    ...
    def create_bubble():  # CREAR POMPAS
        ...
        bubble_speed.append(random.randint(0,MAX_BUBBLE_SPEED))
    ...
    # FIN JUEGO
    c.create_text(MID_X, MID_Y, text='GAME OVER', fill='blue',
            font=('Helvetica', 30))
